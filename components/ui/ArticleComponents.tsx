      ...
      <article className="group relative bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-emerald-200 transform hover:-translate-y-1 md:hover:-translate-y-2 h-full">
        ...
        <div className="p-4 sm:p-6 md:p-8 flex flex-col h-full">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center text-xs sm:text-sm text-gray-500 mb-1">
                  <svg className="w-3 h-3 sm:w-4 sm:h-4 mx-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="flex-grow">
            <h3 className="font-bold text-lg sm:text-xl md:text-2xl text-gray-900 mb-3 sm:mb-4 group-hover:text-emerald-700 transition-colors duration-300 leading-tight" 
                dir="auto"
                style={{
                  display: '-webkit-box',
                  WebkitLineClamp: 2,
            ...
            <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 sm:mb-6 line-clamp-3 sm:line-clamp-2" dir="auto">
              {article.excerpt}
            </p>
          </div>
        ...
        <div className="absolute inset-0 bg-emerald-900 bg-opacity-70 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center p-4 sm:p-6 md:p-8 hidden sm:flex">
          <div className="text-center text-white min-w-full">
            ...
            {/* Article Title */}
            <h4 className="font-bold text-lg sm:text-xl mb-3 sm:mb-4 text-white" dir="auto">
              {article.title}
            </h4>
            ...
            <div className="w-full min-w-full bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-white border-opacity-20 mb-4 sm:mb-6">
              <p className="text-white text-xs sm:text-sm leading-relaxed max-h-24 sm:max-h-32" dir="auto">
                {article.excerpt}
              </p>
            </div>
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 sm:gap-4 md:gap-6 text-sm">
      <div className="flex items-center space-x-2">
        ...
        <span className="text-gray-700 font-medium text-xs sm:text-sm truncate">{author}</span>
      </div>
      ...
      <div className="flex items-center space-x-2">
        ...
        <span className="text-gray-600 text-xs sm:text-sm">{formatDate(date)}</span>
      </div>
