...
export default async function LibraryBrochurePage({
  ...
  // Mock brochure data (in real app, this would be from database/API)
  const brochureData: BrochureData | null = getBrochureData(
    brochureId,
    isArabic,
  );
    ...
    <main className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50">
      <SkipLinks
        links={[
          ...
          {
            href: "#pdf-viewer",
            label: isArabic ? "الانتقال إلى عارض PDF" : "Skip to PDF viewer",
          },
        ]}
      />
      ...
      <div id="main-content" className="container mx-auto px-4 py-8">
        ...
        >
          ...
          >
            ...
            <li className="text-gray-400">/</li>
            <li>
              <span className="text-emerald-600">{library.brochures}</span>
            </li>
            <li className="text-gray-400">/</li>
        ...
        <Motion delay={0.1}>
          <div className="mb-8">
            ...
            {/* Brochure Metadata */}
            <div
              className={`grid grid-cols-2 md:grid-cols-4 gap-4 bg-white rounded-lg p-6 shadow-sm ${isArabic ? "text-right" : ""}`}
            >
              <div>
            ...
            {/* Action Buttons */}
            <div
              className={`flex gap-4 mt-6 ${isArabic ? "flex-row-reverse" : ""}`}
            >
              <a
