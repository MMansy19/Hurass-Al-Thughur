  ...
  const issues: Record<string, MagazineIssue> = {
    ...
    "4": {
      ...
      description: isArabic
        ? "دليل شامل للأخلاق الإسلامية وتطبيقها في الحياة اليومية"
        : "A comprehensive guide to Islamic ethics and their application in daily life",
      ...
      pageCount: 28,
      author: isArabic ? "فريق التحرير" : "Editorial Team",
      tags: [isArabic ? "الأخلاق" : "Ethics", isArabic ? "السلوك" : "Behavior"],
    },
    "5": {
      id: "5",
      title: isArabic ? "الزكاة وأحكامها" : "Zakat and its Rulings",
      description: isArabic
        ? "دليل مفصل لأحكام الزكاة ومقاديرها"
        : "A detailed guide to Zakat rulings and amounts",
      ...
      pageCount: 24,
      author: isArabic ? "فريق التحرير" : "Editorial Team",
      tags: [isArabic ? "الزكاة" : "Zakat", isArabic ? "الأحكام" : "Rulings"],
    },
    "6": {
      id: "6",
      title: isArabic ? "الدعاء في الإسلام" : "Prayer in Islam",
      description: isArabic
        ? "آداب الدعاء وأوقاته المستجابة"
        : "Etiquette of prayer and blessed times for supplication",
      ...
      pageCount: 34,
      author: isArabic ? "فريق التحرير" : "Editorial Team",
      tags: [isArabic ? "الدعاء" : "Prayer", isArabic ? "الآداب" : "Etiquette"],
    },
  };
...
export default async function MagazineIssuePage({
  ...
  const skipLinks = [
    ...
    {
      href: "#pdf-viewer",
      label: isArabic ? "انتقل إلى عارض PDF" : "Skip to PDF viewer",
    },
    {
      href: "#issue-info",
      label: isArabic
        ? "انتقل إلى معلومات الإصدار"
        : "Skip to issue information",
    },
  ];
                ...
                <div className="flex flex-wrap gap-4 text-emerald-100">
                  ...
                  {issueData.pageCount && (
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        {issueData.pageCount} {isArabic ? "صفحة" : "pages"}
                      </span>
                    </div>
                  )}
                </div>
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                  <MagazineIssueViewer
                    ...
                    messages={{
                      ...
                      searchResults:
                        messages.hardcoded?.searchResults || "Search Results",
                      thumbnails:
                        messages.hardcoded?.thumbnails || "Thumbnails",
                      fullscreen:
                        messages.hardcoded?.fullscreen || "Fullscreen",
                      ...
                      pdfViewer: {
                        loadingViewer:
                          ...
                          "Loading PDF Viewer",
                        loadingDocument:
                          messages.hardcoded?.loadingDocument ||
                          "Please wait while we prepare your document...",
                        errorLoadingPDFs:
                          messages.hardcoded?.errorLoadingPDFs ||
                          "Error Loading PDF",
                      },
                    }}
                  />
