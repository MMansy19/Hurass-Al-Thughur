...
export async function generateMetadata({
  ...
  return {
    ...SEO({
      ...
      description:
        messages.magazine.description + " - " + messages.magazine.allIssues,
      locale,
        ...
        <Motion preset="fadeInUp" delay={300}>
          <section id="issues-grid" className="py-8">
            <div className="container mx-auto sm:px-4 px-2">
                ...
                <div className="flex items-center gap-4">
                  ...
                  >
                    <option value="date-desc">
                      {messages.hardcoded.newestFirst}
                    </option>
                    <option value="date-asc">
                      {messages.hardcoded.oldestFirst}
                    </option>
              ...
              <Suspense
                fallback={<MagazineGridSkeleton count={6} columns={3} />}
              >
                {" "}
                <AccessibleGrid
                  columns={3}
