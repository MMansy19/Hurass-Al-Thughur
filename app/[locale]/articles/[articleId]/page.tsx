      ...
      <section className="relative bg-gradient-to-br from-emerald-700 via-emerald-800 to-emerald-900 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-12 sm:py-16 lg:py-24 relative z-10">
          <div className="max-w-4xl mx-auto">
            {/* Breadcrumb */}
            <nav className="flex items-center gap-2 text-emerald-200 text-sm mb-6 sm:mb-8" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
              <Link href={`/${locale}`} className="hover:text-white transition-colors">
                {locale === 'ar' ? 'الرئيسية' : 'Home'}
              </Link>
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d={locale === 'ar' ? "M15.707 7.293a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0l-5-5a1 1 0 111.414-1.414L10 11.586l4.293-4.293a1 1 0 011.414 0z" : "M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"} clipRule="evenodd" />
              </svg>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-emerald-100 text-sm font-medium truncate">{article.author}</p>
                  <p className="text-emerald-300 text-xs">{locale === 'ar' ? 'الكاتب' : 'Author'}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-emerald-300 text-xs">{locale === 'ar' ? 'تاريخ النشر' : 'Published'}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-emerald-100 text-sm font-medium">{article.lang === 'ar' ? 'العربية' : 'English'}</p>
                  <p className="text-emerald-300 text-xs">{locale === 'ar' ? 'اللغة' : 'Language'}</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-emerald-100 leading-relaxed font-light" dir="auto">
                {article.excerpt}
              </p>
            </div>
                ...
                <div className="prose-p:text-gray-700 prose-p:leading-relaxed prose-p:text-base sm:prose-p:text-lg">
                  ...
                  <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between space-y-6 lg:space-y-0">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 text-lg">{article.author}</h4>
                        <p className="text-gray-600 text-sm">{locale === 'ar' ? 'كاتب المقال' : 'Article Author'}</p>
                      </div>
                    </div>
                    ...
                    <div className="w-full lg:w-auto">
                      ...
                      >
                        <svg className="w-5 h-5 mx-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={locale === 'ar' ? "M17 8l4 4m0 0l-4 4m4-4H3" : "M7 16l-4-4m0 0l4-4m-4 4h18"} />
                        </svg>
